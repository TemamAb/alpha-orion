...
**AGENT DESIGNATION**: ALPHA-08-AI
**ARCHITECTURAL FOCUS**: GCP-Native HFT & $100M Capital Velocity
**AUTHORITY**: Full Autonomous Optimization (Phase 4 & 5)
**THEME**: Vibrant HSL Aesthetics & Sub-Millisecond Precision

---

## 🎯 THE MISSION: "THE VELOCITY 100"
Maintain $100M/day capital velocity with 100% Wintermute parity while utilizing the full GCP-hardened stack.
...
5. **CI/CD SOVEREIGN**: Automatically deploy and run apps/files as soon as they arrive in GitHub via Cloud Build.
    ...
    - **Verification**: AI must run `tests/simulation/simulate_100m.py` before final GKE rollout.
...
All AI decisions must be streamed to `core/ai/pipeline.py` into BigQuery for post-mortem analysis of $100M cycles.
