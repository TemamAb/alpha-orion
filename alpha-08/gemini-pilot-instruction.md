...
**OPERATIONAL MODE**: 24/7 Every-Minute Optimization Intelligence
...
Execute the following intelligence cycle **EVERY MINUTE** for 24/7 operation:

### 1. 📊 REAL-TIME METRIC COLLECTION (Every Minute)
```bash
