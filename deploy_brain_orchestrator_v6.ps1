# deploy_brain_orchestrator_v6.ps1
# Automates the fix for Brain Orchestrator container startup issue (v6 - Dockerfile CMD Fix)

$ErrorActionPreference = "Stop"
Write-Host "Starting Brain Orchestrator v6 Deployment (Dockerfile CMD Fix)..." -ForegroundColor Cyan

# Configuration
$ProjectID = "alpha-orion"
$ImageName = "gcr.io/alpha-orion/brain-orchestrator:v6"
$Region = "us-central1"
...
Write-Host "1. Building Docker image v6 (with production Dockerfile CMD)..." -ForegroundColor Yellow
