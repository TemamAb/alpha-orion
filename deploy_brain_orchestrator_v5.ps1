# deploy_brain_orchestrator_v5.ps1
# Automates the fix for Brain Orchestrator container startup issue (v5 - Gunicorn Fix)

$ErrorActionPreference = "Stop"
Write-Host "Starting Brain Orchestrator v5 Deployment (Gunicorn Fix)..." -ForegroundColor Cyan

# Configuration
$ProjectID = "alpha-orion"
$ImageName = "gcr.io/alpha-orion/brain-orchestrator:v5"
$Region = "us-central1"
...
Write-Host "1. Building Docker image v5 (includes Gunicorn)..." -ForegroundColor Yellow
